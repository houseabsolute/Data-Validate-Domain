...
sub _domain_labels {
    ...
    # FYI: DNS limits names to 255 octets, encoded to RDATA.
    # Each label includes a length-octet prefix; those length octets count
    # against the 255-octet maximum. The number of labels exceeds the number
    # of dots by 1 (assuming no trailing dot), and the number of length
    # octets exceeds number of labels by 1 (since there’s always a trailing
    # NUL octet). The effective limit is thus 255 - 1 - 1, or 253.
